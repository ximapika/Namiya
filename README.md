...
“每一封信，都是一颗心的重量。”这是为北京大学心理协会解忧杂货铺制作的一个项目，已经部署在clab上，北大学生可以通过http://10.129.246.213:50000访问（需要校园网环境）。
只做了简单的防护，大概是扛不住ddos等攻击的，求大佬放过。也欢迎提交pr一起维护项目！

我觉得解忧杂货铺这个项目很有意义，能为大家提供安全的同辈倾诉平台，介于树洞和心理中心的电话之间。希望能给其他高校的有同样想法的心理协会一些简单的借鉴和项目demo。
以下是项目的介绍：
